 ...
 * @param {*} isReadonly 是不是只读  FIXME: 只读功能的实现
 * @return {*}
 */
    ...
    get(target,key, receiver) {
      ...
      // FIXME:只有是非只读的时候才需要建立响应关系
       ...
       if (typeof res === 'object' && res !== null) {
        ...
        //  FIXME: 深度只读实现的关键点，如果数据是只读，继续调用readOnly对值进行包装
...
// TODO: 一个很重要的知识点： 函数嵌套函数，参数是可以隔代空传的，没必要代代都带着